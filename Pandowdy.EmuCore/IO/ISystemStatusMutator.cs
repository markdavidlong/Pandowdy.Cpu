...
public interface ISystemStatusMutator : ISystemStatusProvider
{
    ...
    /// Apple IIe hardware behavior (managed by <see cref="Machine.VA2M"/> flash timer).
    /// </para>
    /// </remarks>
    ...
    /// <remarks>
    /// <para>
    /// This value is updated periodically by <see cref="Machine.VA2M"/> based on actual emulation performance.
