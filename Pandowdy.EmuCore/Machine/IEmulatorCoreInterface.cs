...
public interface IEmulatorCoreInterface : IKeyboardSetter
{
    ...
    /// messages like <see cref="Slots.IdentifyCardMessage"/> where all cards should respond.
    ...
    /// </para>
        ...
        /// <remarks>
        /// <para>
        /// <strong>Thread Safety:</strong> Thread-safe read-only property. The returned <see cref="IDiskStatusProvider"/>
        ...
        /// disk insertion, etc.) through the provider. Subscribe to <see cref="IDiskStatusProvider.Stream"/>
        ...
        /// </para>
        /// </remarks>
        IDiskStatusProvider DiskStatus { get; }
        ...
        /// <see cref="CpuStateSnapshot.AtInstructionBoundary"/> to check if at a safe point.
        /// </para>
        /// <para>
