...
/// <see cref="IO.ISystemStatusProvider"/> (HighRead, HighWrite, UseBank1). Soft switch transitions
/// are managed by <see cref="IO.SoftSwitches"/>; this interface only handles memory access routing.
/// </para>
/// </remarks>
/// <seealso cref="IO.ISystemStatusProvider"/>
