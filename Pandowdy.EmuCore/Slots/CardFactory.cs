...
/// <see cref="Machine.RestartCollection.RestartAll"/>, which iterates all installed cards and calls
/// <see cref="Machine.IRestartable.Restart"/>. Cards do not need to be registered
