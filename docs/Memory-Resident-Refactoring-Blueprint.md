...
- Remove `Microsoft.Data.Sqlite` PackageReference (no longer needed until `SqliteProjectStore`).
- Remove `System.Reactive` PackageReference (unused in this project).

**(Plan: "Modified Files" table → `Pandowdy.Project.csproj`)**
